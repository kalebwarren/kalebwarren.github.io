(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.kennedi, 230, 180, 6, .7);
        collectable.create(type.steve, 100, 10, 6, .7);
        collectable.create(type.grace, 500, 100, 6, .7);
        collectable.create(type.max, 850, 50, 50, .7);
